...
% output:
% E_2_gamma_n is the gradient between cost E and γ(n-1)
% E_2_rho_n is the gradient between cost E and ρ(n-1)
% E_2_beta_nMinus1 is the gradient between cost E and β(n-1)
...
% beta_n_Minus_1 is n-1 layer of β
