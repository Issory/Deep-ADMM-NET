...
[E_2_gamma_3,E_2_rho_3,E_2_beta_2,E_2_z_2]=ReconstructionLayerGradient(E_2_x_3,P,F,y,H_3,B_3,rho_3,z_2,beta_2,1,3);
...
[E_2_eta_1,E_2_beta_1,E_2_c_2,E_2_z_2] = MultiplierUpdateLayerGradient(E_2_beta_2,c_2,z_2,eta_2,1);
toc;
...
[e_2_q2,e_2_beta1_second,e_2_c2_second]= NonlinearTransformLayerGradient(E_2_z2,c_2,beta_1,q_2,1);
toc;
...
tic;
% E gradient
E_2_c_2 = {cell2mat(E_2_c2_first)+ cell2mat(E_2_c2_second)};
